...
Does mask use acceptance have any relation with some demographics? To answer this question, first I would like to get the data from Github source https://github.com/nytimes/covid-19-data/tree/master/mask-use
...
I will be using Kieran Healy's `socviz` package which among other things contains `county_map` and `county_data`  
...
Does mask use acceptance have any relation with some demographics? Let me explore the relationship between country household income, population, and % who voted republican in 2016
